	...
	<div class="pleesher-table">
		<div class="pleesher-row">
			<div class="pleesher-cell pleesher-cell-logo">
				<div class="pleesher-liquipedia-logo pleesher-item-image_<?php echo str_replace( ' ', '-', trim( preg_replace( '/[^a-z0-9\- ]/', '', strtolower( $goal->title ) ) ) ); ?> wiki-backgroundcolor-dark"></div>
			</div>
				...
				<div class="pleesher-achievement"><!--
					...
					--><?php if ( isset( $user ) && !empty( $goal->achieved ) && in_array( 'revoke', $actions ) && !PleesherExtension::isDisabled() ): ?><!--
						--><div class="pleesher-achievement-revoke"><!--
							--><a data-redirect="self" href="<?php echo $h->actionUrl( 'pleesher.revoke_achievement', [ 'user_name' => $user->getName(), 'goal_id' => $goal->id, 'duration' => 'forever' ] ); ?>" data-confirm="<?php echo $h->text( 'pleesher.revoke_achievement.confirm' ); ?>">Revoke</a><!--
							--></div><!--
						--><?php endif; ?><!--
