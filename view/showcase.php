<div class="pleesher-showcase">
	...
	<div class="pleesher-showcase-item pleesher-item-image_<?php echo str_replace(' ', '-', trim(preg_filter('/[^a-z0-9 ]/', '', strtolower($showcased_goal->title)))) ?>" title="<?php echo $showcased_goal->title ?>" data-toggle="popover-hover" data-placement="top" data-content="<?php echo $showcased_goal->short_description ?>">
